...
FX_CALL_HANDLERS = {
    **ATEN_TO_ALLOY,
    ...
    torch.ops.alloy.gguf_q4_k_embedding.default: partial(quant_embedding, Q4_K),
    torch.ops.alloy.gguf_q4_k_mm.default: partial(quant_mm, Q4_K),
    torch.ops.alloy.batched_gguf_q4_k_mm.default: partial(quant_mm_batched, Q4_K),
    torch.ops.alloy.gguf_q4_k_silu.default: partial(quant_mm_fused, Q4_K, "silu"),
    torch.ops.alloy.gguf_q4_k_gelu.default: partial(quant_mm_fused, Q4_K, "gelu"),
    torch.ops.alloy.mlx_q4_mm.default: partial(quant_mm, MLX_Q4),
    torch.ops.alloy.batched_mlx_q4_mm.default: partial(quant_mm_batched, MLX_Q4),
    torch.ops.alloy.mlx_q4_silu.default: partial(quant_mm_fused, MLX_Q4, "silu"),
    torch.ops.alloy.mlx_q4_embedding.default: partial(quant_embedding, MLX_Q4),
    torch.ops.alloy.gguf_moe_routed.default: _gguf_moe_routed_handler,
    torch.ops.alloy.gguf_q5_0_embedding.default: partial(quant_embedding, Q5_0),
    torch.ops.alloy.gguf_q5_0_mm.default: partial(quant_mm, Q5_0),
    torch.ops.alloy.batched_gguf_q5_0_mm.default: partial(quant_mm_batched, Q5_0),
    torch.ops.alloy.gguf_q6_k_mm.default: partial(quant_mm, Q6_K),
    torch.ops.alloy.batched_gguf_q6_k_mm.default: partial(quant_mm_batched, Q6_K),
    torch.ops.alloy.gguf_q6_k_embedding.default: partial(quant_embedding, Q6_K),
    torch.ops.alloy.gguf_q8_0_embedding.default: partial(quant_embedding, Q8_0),
    torch.ops.alloy.gguf_q8_0_mm.default: partial(quant_mm, Q8_0),
    torch.ops.alloy.batched_gguf_q8_0_mm.default: partial(quant_mm_batched, Q8_0),
    torch.ops.alloy.gguf_q8_0_silu.default: partial(quant_mm_fused, Q8_0, "silu"),
